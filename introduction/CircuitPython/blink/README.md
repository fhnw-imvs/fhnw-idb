...
Additional details on how files are run after a reset, are available in the CircuitPython documentation under [Behavior](https://docs.circuitpython.org/en/7.3.x/docs/index.html#behavior).
